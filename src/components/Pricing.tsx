  ...
  return (
    <section id="pricing" className="py-24 bg-muted">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {plans.map((plan) => (
            ...
            >
              ...
              <div className="mb-6 text-center">
                ...
                {plan.period && <p className="text-xs text-muted-foreground mt-1">{plan.period}</p>}
              </div>
        ...
        {/* BOTTOM CTA */}
        <ScrollReveal variant="fade-up" delay={300} className="mt-16 text-center">
          ...
          <div className="flex justify-center">
            <Button
              ...
              className="bg-slate-900 text-white font-medium px-8 transition-colors hover:bg-[#3A8F94] focus-visible:bg-[#3A8F94]"
            >
