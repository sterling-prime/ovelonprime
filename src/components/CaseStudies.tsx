...
const TabButton = ({
  ...
  <button
    ...
    className={cn(
      ...
      isActive ? "text-accent" : "text-primary-foreground/40 hover:text-primary-foreground/60"
    )}
  >
    {children}
    {isActive && (
...
export const CaseStudies = () => {
  ...
  const results = t(`caseStudies.cases.${activeKey}.results`, { returnObjects: true }) as {
    value: string;
    label: string;
  }[];
    ...
    <section className="py-32 px-6 md:px-12 bg-primary">
      <div className="max-w-6xl mx-auto">
        ...
        <ScrollReveal variant="fade-up" delay={100}>
          <div className="mb-12">
            <div className="flex overflow-x-auto gap-2 border-b border-primary-foreground/10 pb-0 justify-start md:justify-center scrollbar-none">
              {caseKeys.map((key, index) => (
                ...
                >
                  <span className="text-primary-foreground/30 mr-2 font-light">{`0${index + 1}`}</span>
              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    {results.map((result) => (
                      <div key={result.label} className="text-center p-4 border border-primary-foreground/10 rounded">
