 ...
 const DemoTab = ({ active, onClick, children, icon: Icon }: DemoTabProps) => (
   <button
     onClick={onClick}
     className={cn(
       "flex items-center gap-2 px-6 py-3 text-sm font-medium transition-all duration-300 border-b-2",
       active
 ...
 export const WorkflowDemo = () => {
   const { t } = useTranslation();
   const [activeTab, setActiveTab] = useState<"workflow" | "call">("workflow");
   ...
   return (
     <section className="py-32 px-6 md:px-12 bg-primary">
       <div className="max-w-6xl mx-auto">
         ...
         <div className="flex justify-center mb-8 border-b border-primary-foreground/10">
           <DemoTab
