        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="bg-card rounded-2xl shadow-xl p-10 border border-border">
              ...
              <p className="mb-6 text-xs tracking-[0.3em] font-semibold uppercase text-accent text-center sm:text-left">
                ENGAGE
              </p>
              ...
              <p className="text-lg text-muted-foreground mb-12 text-center sm:text-left">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2 text-center sm:text-left">
                  ...
                  <Textarea
                    className="min-h-[120px] mx-auto sm:mx-0"
