    ...
    <section id="about" className="py-24 bg-muted/30">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
          <ScrollReveal variant="slide-left" delay={100} className="space-y-6">
          ...
          <ScrollReveal variant="slide-right" delay={200} className="relative">
        ...
        <ScrollReveal variant="fade-up" delay={300} className="max-w-3xl mx-auto mt-16">
