      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 text-[14px] text-muted-foreground">
          ...
          <div className="flex gap-6">
            <a href="https://www.linkedin.com/company/ovelon-prime/" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors duration-200">
              <LinkedInIcon className="h-6 w-6" />
            </a>
            <a href="https://www.facebook.com/ovelon-prime" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors duration-200">
