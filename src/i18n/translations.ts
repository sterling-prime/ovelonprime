...
export const translations: Record<Lang, any> = {
  ...
  en: {
    ...
    contactInfo: {
      ...
      preferCallDesc: "Schedule a consultation at your convenience. Our team is ready to discuss your operational needs.",
  ...
  de: {
    ...
    contactInfo: {
      ...
      preferCallDesc: "Vereinbaren Sie eine Beratung zu einem für Sie passenden Zeitpunkt. Unser Team steht bereit.",
      scheduleCta: "ANRUF VEREINBAREN",
    },
    faq: {
  ...
  fr: {
    ...
    contactInfo: {
      ...
      preferCallDesc: "Planifiez une consultation à votre convenance. Notre équipe est prête à discuter de vos besoins.",
  ...
  es: {
    ...
    contactInfo: {
      ...
      sunday: "Domingo",
      closed: "Cerrado",
      preferCall: "¿Prefiere una llamada?",
      preferCallDesc: "Programe una consulta a su conveniencia. Nuestro equipo está listo para discutir sus necesidades.",
      scheduleCta: "PROGRAMAR LLAMADA",
    },
    faq: {
  ...
  it: {
    ...
    contactInfo: {
      ...
      sunday: "Domenica",
      closed: "Chiuso",
      preferCall: "Preferisci una chiamata?",
      preferCallDesc: "Pianifica una consulenza a tuo piacimento. Il nostro team è pronto a discutere le tue esigenze.",
      scheduleCta: "PIANIFICA UNA CHIAMATA",
    },
    faq: {
  ...
  pt: {
    ...
    contactInfo: {
      ...
      preferCallDesc: "Agende uma consulta à sua conveniência. A nossa equipa está pronta para discutir as suas necessidades.",
      scheduleCta: "AGENDAR CHAMADA",
    },
    faq: {
