  ...
  en: {
    ...
    hero: {
     ...
     process: {
       ...
       step1: { title: "Capture", description: "Every call, message, and booking request is handled with precision the moment it arrives." },
     ...
     workflowDemo: {
       ...
       title: "See Oppera in action.",
       tabs: { workflow: "Workflow Automation", call: "Call Recovery" },
       workflow: {
         ...
         step1: { title: "Inquiry Received", desc: "Guest calls requesting a table for 4" },
         step2: { title: "Availability Checked", desc: "Real-time calendar sync confirms 8:00 PM slot" },
         step3: { title: "Reservation Created", desc: "Table 12 reserved for party of 4" },
         step4: { title: "Confirmation Sent", desc: "Email & SMS confirmation delivered to guest" },
         step5: { title: "Staff Notified", desc: "Kitchen and service team alerted" },
         step6: { title: "Guest Profile Updated", desc: "Preferences and visit history logged" },
       },
       call: {
         description: "See how Oppera transforms a potentially missed opportunity into a confirmed booking.",
         simulate: "SIMULATE INCOMING CALL",
         stage1: "Incoming call...",
         stage2: "Without Oppera: Call missed",
         stage3: "With Oppera: Call answered instantly",
         stage4: "Guest request captured",
         stage5: "Booking confirmed",
         revenueLost: "Revenue lost. Guest disappointed.",
         revenueCaptured: "Revenue captured. Guest delighted.",
       },
     },
    video: {
  ...
  de: {
    ...
    hero: {
     ...
     workflowDemo: {
       ...
       title: "Sehen Sie Oppera in Aktion.",
       tabs: { workflow: "Workflow-Automatisierung", call: "Anrufwiederherstellung" },
       workflow: {
         ...
         step1: { title: "Anfrage eingegangen", desc: "Gast ruft an und bittet um einen Tisch für 4" },
         step2: { title: "Verfügbarkeit geprüft", desc: "Echtzeit-Kalendersync bestätigt 20:00 Uhr Slot" },
         step3: { title: "Reservierung erstellt", desc: "Tisch 12 für 4 Personen reserviert" },
         step4: { title: "Bestätigung gesendet", desc: "E-Mail- & SMS-Bestätigung an Gast zugestellt" },
         step5: { title: "Personal benachrichtigt", desc: "Küche und Serviceteam informiert" },
         step6: { title: "Gästeprofil aktualisiert", desc: "Präferenzen und Besuchshistorie protokolliert" },
       },
       call: {
         description: "Sehen Sie, wie Oppera eine potenziell verpasste Gelegenheit in eine bestätigte Buchung verwandelt.",
         simulate: "EINGEHENDEN ANRUF SIMULIEREN",
         stage1: "Eingehender Anruf...",
         stage2: "Ohne Oppera: Anruf verpasst",
         stage3: "Mit Oppera: Anruf sofort angenommen",
         stage4: "Gastwunsch erfasst",
         stage5: "Buchung bestätigt",
         revenueLost: "Umsatz verloren. Gast enttäuscht.",
         revenueCaptured: "Umsatz gesichert. Gast begeistert.",
       },
     },
    video: {
  ...
  fr: {
    ...
    hero: {
     ...
     workflowDemo: {
       ...
       title: "Voyez Oppera en action.",
       tabs: { workflow: "Automatisation du Flux", call: "Récupération d'Appels" },
       workflow: {
         ...
         step1: { title: "Demande reçue", desc: "Un client appelle pour réserver une table pour 4" },
         step2: { title: "Disponibilité vérifiée", desc: "Sync calendrier en temps réel confirme le créneau de 20h00" },
         step3: { title: "Réservation créée", desc: "Table 12 réservée pour un groupe de 4" },
         step4: { title: "Confirmation envoyée", desc: "Confirmation par e-mail et SMS envoyée au client" },
         step5: { title: "Personnel notifié", desc: "Cuisine et équipe de service alertées" },
         step6: { title: "Profil client mis à jour", desc: "Préférences et historique de visites enregistrés" },
       },
       call: {
         description: "Découvrez comment Oppera transforme une opportunité potentiellement manquée en une réservation confirmée.",
         simulate: "SIMULER UN APPEL ENTRANT",
         stage1: "Appel entrant...",
         stage2: "Sans Oppera : Appel manqué",
         stage3: "Avec Oppera : Appel répondu instantanément",
         stage4: "Demande client capturée",
         stage5: "Réservation confirmée",
         revenueLost: "Revenu perdu. Client déçu.",
         revenueCaptured: "Revenu capturé. Client ravi.",
       },
     },
    video: {
  ...
  es: {
    ...
    hero: {
     ...
     workflowDemo: {
       ...
       title: "Ve Oppera en acción.",
       tabs: { workflow: "Automatización de Flujos", call: "Recuperación de Llamadas" },
       workflow: {
         ...
         step1: { title: "Consulta recibida", desc: "El cliente llama solicitando una mesa para 4" },
         step2: { title: "Disponibilidad verificada", desc: "Sincronización de calendario en tiempo real confirma el horario de las 20:00" },
         step3: { title: "Reserva creada", desc: "Mesa 12 reservada para grupo de 4" },
         step4: { title: "Confirmación enviada", desc: "Confirmación por correo electrónico y SMS entregada al cliente" },
         step5: { title: "Personal notificado", desc: "Cocina y equipo de servicio alertados" },
         step6: { title: "Perfil del cliente actualizado", desc: "Preferencias e historial de visitas registrados" },
       },
       call: {
         description: "Ve cómo Oppera transforma una oportunidad potencialmente perdida en una reserva confirmada.",
         simulate: "SIMULAR LLAMADA ENTRANTE",
         stage1: "Llamada entrante...",
         stage2: "Sin Oppera: Llamada perdida",
         stage3: "Con Oppera: Llamada contestada al instante",
         stage4: "Solicitud del cliente capturada",
         stage5: "Reserva confirmada",
         revenueLost: "Ingresos perdidos. Cliente decepcionado.",
         revenueCaptured: "Ingresos capturados. Cliente encantado.",
       },
     },
    video: {
  ...
  it: {
    ...
    hero: {
     ...
     workflowDemo: {
       ...
       title: "Guarda Oppera in azione.",
       tabs: { workflow: "Automazione del Flusso", call: "Recupero Chiamate" },
       workflow: {
         ...
         step1: { title: "Richiesta ricevuta", desc: "L'ospite chiama per prenotare un tavolo per 4" },
         step2: { title: "Disponibilità verificata", desc: "Sincronizzazione calendario in tempo reale conferma lo slot delle 20:00" },
         step3: { title: "Prenotazione creata", desc: "Tavolo 12 riservato per gruppo di 4" },
         step4: { title: "Conferma inviata", desc: "Conferma via email e SMS consegnata all'ospite" },
         step5: { title: "Staff notificato", desc: "Cucina e team di servizio avvisati" },
         step6: { title: "Profilo ospite aggiornato", desc: "Preferenze e cronologia visite registrate" },
       },
       call: {
         description: "Guarda come Oppera trasforma un'opportunità potenzialmente persa in una prenotazione confermata.",
         simulate: "SIMULA CHIAMATA IN ARRIVO",
         stage1: "Chiamata in arrivo...",
         stage2: "Senza Oppera: Chiamata persa",
         stage3: "Con Oppera: Chiamata risposta istantaneamente",
         stage4: "Richiesta ospite acquisita",
         stage5: "Prenotazione confermata",
         revenueLost: "Ricavi persi. Ospite deluso.",
         revenueCaptured: "Ricavi acquisiti. Ospite entusiasta.",
       },
     },
    video: {
  ...
  pt: {
    ...
    hero: {
     ...
     workflowDemo: {
       ...
       title: "Veja Oppera em ação.",
       tabs: { workflow: "Automação de Fluxo", call: "Recuperação de Chamadas" },
       workflow: {
         ...
         step1: { title: "Consulta recebida", desc: "O hóspede liga a pedir uma mesa para 4" },
         step2: { title: "Disponibilidade verificada", desc: "Sincronização de calendário em tempo real confirma o horário das 20:00" },
         step3: { title: "Reserva criada", desc: "Mesa 12 reservada para grupo de 4" },
         step4: { title: "Confirmação enviada", desc: "Confirmação por email e SMS entregue ao hóspede" },
         step5: { title: "Equipa notificada", desc: "Cozinha e equipa de serviço alertadas" },
         step6: { title: "Perfil do hóspede atualizado", desc: "Preferências e histórico de visitas registados" },
       },
       call: {
         description: "Veja como Oppera transforma uma oportunidade potencialmente perdida numa reserva confirmada.",
         simulate: "SIMULAR CHAMADA RECEBIDA",
         stage1: "Chamada a entrar...",
         stage2: "Sem Oppera: Chamada perdida",
         stage3: "Com Oppera: Chamada atendida instantaneamente",
         stage4: "Pedido do hóspede capturado",
         stage5: "Reserva confirmada",
         revenueLost: "Receita perdida. Hóspede desapontado.",
         revenueCaptured: "Receita capturada. Hóspede encantado.",
       },
     },
    video: {
