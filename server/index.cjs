...
const generatePDF = (data, referenceId, submissionDate) => {
  ...
  y += 4;
  doc.text('For questions, contact info@ovelon-prime.com', margin, y);
...
<body>
  ...
  ${pdfGenerationFailed ? '<p style="color: #c53030;">⚠️ PDF generation failed for this submission</p>' : ''}
    ...
    const internalToEmail = process.env.INTERNAL_EMAIL || "info@ovelon-prime.com";
...
<body>
  ...
  <div class="footer">
    ...
    For support, contact <a href="mailto:info@ovelon-prime.com">info@ovelon-prime.com</a></p>
  </div>
</body>
</html>
    `;
